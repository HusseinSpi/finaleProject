...
const Parenting = () => {
  ...
  return (
    <div
      className="flex flex-col gap-6 p-4 bg-purple-50"
      // style={{
      //   background: `url(${bg})`,
      ...
      // }}
    >
      <div className=" text-blue-950 rounded-xl w-full max-w-4xl p-4 mx-auto flex flex-col items-center">
        <h1 className="  text-center text-3xl font-bold mb-4 font-theren ">
      ...
      {combinedData.map((item, index) => (
        ...
        >
          ...
          <div className="flex flex-col md:w-1/2 gap-4">
            <div className="border-b-2 border-purple-800 p-2">
