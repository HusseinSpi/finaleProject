...
const Messages = () => {
  ...
  return (
    <div className="flex flex-col items-center h-screen p-4 text-black">
      <h1 className="text-4xl font-bold mb-8">Open tickets</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
        {rooms.length > 0 ? (
          rooms.map((room) => (
            ...
            >
              <h2 className="text-2xl font-semibold">Tickets {room._id}</h2>
