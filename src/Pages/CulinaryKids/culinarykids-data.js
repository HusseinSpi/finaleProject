...
import gefilteFish from "../../../public/gefilteFish.jpg";

import sufganiot from "../../../public/sufganiot.jpg";

import ozneiAman from "../../../public/ozneiAman.png";
...
const culinaryKidsData = [
  ...
  },
  {
    ...
    recipeTitleEn: "Gefilte Fish",
    recipeTitleHe: "געפילטע פיש",
    recipeTitleAr: "جيفيلتي فيش",
    ingredientsEn: [
      "1 kg of white fish fillets (carp, pike, or tilapia), finely minced",
    ...
    ingredientsHe: [
      "1 ק''ג פילה דג לבן (קרפיון, פייק, או טילפיה), טחון דק",
      "בצל גדול, מגורר",
      "2 ביצים",
      "1 כף סוכר",
    ...
    ingredientsAr: [
      "1 كجم من شرائح السمك الأبيض (كارپ، بايك، أو تيلابيا)، مفروم ناعماً",
      "1 بصلة كبيرة، مبشورة",
      "2 بيض",
      "1 ملعقة كبيرة سكر",
      "ملح وفلفل أسود، حسب الذوق",
      "1/2 كوب دقيق ماتزا أو فتات خبز",
      "ماء للسلق",
      "2 جزرة، مقطعة شرائح",
      "بقدونس طازج للتزيين",
    ],
    preparationMethodEn: [
      "In a large bowl, mix minced fish with grated onion, eggs, sugar, salt, and pepper.",
      "Add matzo meal or bread crumbs and mix until the mixture holds together.",
      "Shape the fish mixture into oval patties using wet hands.",
      "In a large pot, add water and sliced carrots. Season with salt if desired.",
      "Bring to a boil, then gently add the fish patties.",
      "Reduce heat and simmer for 45-60 minutes.",
      "Remove the patties, let cool, and serve with carrot slices and fresh parsley.",
    ],
    preparationMethodHe: [
      "בקערה גדולה, ערבבו את הדג הטחון עם הבצל המגורר, ביצים, סוכר, מלח ופלפל.",
      "הוסיפו קמח מצה או פירורי לחם וערבבו עד שהתערובת מתגבשת.",
      "עצבו את תערובת הדג לפטיסים אובליים בידיים רטובות.",
      "בסיר גדול, הוסיפו מים ופרוסות גזר. תבלו במלח לפי הטעם.",
      "הביאו לרתיחה ואז הכניסו בזהירות את הפטיסים לסיר.",
      "הנמיכו את האש ובשלו על להבה נמוכה במשך 45-60 דקות.",
      "הוציאו את הפטיסים, תנו להם להתקרר, והגישו עם פרוסות הגזר ופטרוזיליה טרייה.",
    ],
    preparationMethodAr: [
      "في وعاء كبير، اخلط السمك المفروم مع البصل المبشور، البيض، السكر، الملح، والفلفل.",
      "أضف دقيق ماتزا أو فتات الخبز واخلط حتى تتماسك المكونات.",
      "شكل خليط السمك إلى فطائر بيضاوية باستخدام أيدٍ مبللة.",
      "في قدر كبير، أضف الماء وشرائح الجزر. تبّل بالملح إذا رغبت.",
      "اجلبه إلى الغليان، ثم أضف الفطائر برفق.",
      "خفف الحرارة واتركه ينضج لمدة 45-60 دقيقة.",
      "أخرج الفطائر، دعها تبرد، وقدمها مع شرائح الجزر والبقدونس الطازج.",
    ],
  },
  {
    id: 20,
    ...
    recipeTitleEn: "Sufganiot",
    recipeTitleHe: "סופגניות",
    recipeTitleAr: "سوفغانيات",
    ingredientsEn: [
    ...
    ingredientsAr: [
      "4 أكواب دقيق لجميع الاستخدامات",
      "2 ملعقة كبيرة سكر",
      "2 1/4 ملعقة صغيرة خميرة جافة",
      "1/2 ملعقة صغيرة ملح",
      "1 كوب ماء دافئ",
      "2 بيض",
      "1/4 كوب زيت نباتي",
    ...
    preparationMethodEn: [
      ...
      "Add warm water, eggs, vegetable oil, and vanilla. Mix until a dough forms.",
      "Knead the dough on a floured surface until smooth. Let it rise for 1-2 hours, covered, until doubled in size.",
      "Roll out the dough to about 1/2 inch thickness and cut out circles.",
      "Let the circles rise for 30 more minutes.",
      "Heat oil in a deep fryer or pot. Fry the dough circles until golden brown on both sides.",
      "Drain on paper towels and fill with jam using a piping bag.",
      "Dust with powdered sugar and serve warm.",
    ],
    preparationMethodHe: [
      "בקערה גדולה, ערבבו קמח, סוכר, שמרים ומלח.",
      "הוסיפו מים חמים, ביצים, שמן צמחי ותמצית וניל. ערבבו עד שהבצק מתגבש.",
      "לושו את הבצק על משטח מקומח עד שהוא חלק. תנו לו לתפוח 1-2 שעות, מכוסה, עד שהוא מכפיל את נפחו.",
      "רדדו את הבצק לעובי של כ-1/2 אינץ' וחתכו עיגולים.",
      "תנו לעיגולים לתפוח עוד 30 דקות.",
      "חממו שמן במחבת עמוקה או סיר. טגנו את העיגולים עד להזהבה משני הצדדים.",
      "הניחו על מגבות נייר ומלאו בריבה באמצעות שקית זילוף.",
      "פזרו אבקת סוכר והגישו חם.",
    ],
    preparationMethodAr: [
      "في وعاء كبير، اخلط الدقيق، السكر، الخميرة، والملح.",
      "أضف الماء الدافئ، البيض، الزيت النباتي، والفانيليا. اخلط حتى تتكون عجينة.",
      "اعجن العجينة على سطح مرشوش بالدقيق حتى تصبح ناعمة. دعها تختمر لمدة 1-2 ساعة مغطاة حتى يتضاعف حجمها.",
      "افرد العجين بسمك حوالي 1/2 بوصة واقطع دوائر.",
      "دع الدوائر ترتفع لمدة 30 دقيقة أخرى.",
      "سخن الزيت في مقلاة عميقة أو قدر. اقلي الدوائر حتى تصبح ذهبية من الجانبين.",
      "صفيها على مناشف ورقية واملأها بالمربى باستخدام كيس التزيين.",
      "رش السكر البودرة وقدّمها دافئة.",
    ],
  },
  {
    id: 21,
    ...
    recipeTitleEn: "Oznei Aman (Hamantaschen)",
    recipeTitleHe: "אוזני המן",
    recipeTitleAr: "أذني هامان",
    ingredientsEn: [
      ...
      "1 teaspoon vanilla extract",
      "Filling of choice (poppy seed, jam, chocolate spread, etc.)",
    ],
    ingredientsHe: [
      "3 כוסות קמח",
      "1 כפית אבקת אפייה",
      ...
      "1 כפית תמצית וניל",
      "מילוי לבחירה (פרג, ריבה, ממרח שוקולד וכו')",
    ],
    ingredientsAr: [
      "3 أكواب دقيق لجميع الاستخدامات",
      ...
      "1 ملعقة صغيرة خلاصة الفانيليا",
      "حشوة حسب الرغبة (بذور الخشخاش، مربى، شوكولاتة قابلة للدهن، إلخ)",
    ],
    preparationMethodEn: [
      "In a large bowl, combine flour, baking powder, salt, and sugar.",
      "Add eggs, vegetable oil (or melted butter), and vanilla extract. Mix until a smooth dough forms.",
      "Wrap the dough in plastic wrap and refrigerate for 1 hour.",
      "Preheat oven to 350°F (175°C) and line a baking sheet with parchment paper.",
      "Roll out the dough on a floured surface to about 1/4 inch thickness and cut out circles.",
      "Place a teaspoon of filling in the center of each circle and fold into a triangular shape, pinching the edges to seal.",
      "Arrange the Hamantaschen on the baking sheet and bake for 12-15 minutes or until lightly golden.",
      "Let cool before serving.",
    ],
    preparationMethodHe: [
      "בקערה גדולה, ערבבו קמח, אבקת אפייה, מלח וסוכר.",
      "הוסיפו ביצים, שמן צמחי (או חמאה מומסת) ותמצית וניל. ערבבו עד לקבלת בצק חלק.",
      "עטפו את הבצק בניילון נצמד והכניסו למקרר לשעה.",
      "חממו תנור ל-350°F (175°C) ורפדו תבנית אפייה בנייר אפייה.",
      "רדדו את הבצק על משטח מקומח לעובי של כ-1/4 אינץ' וחתכו עיגולים.",
      "הניחו כפית מילוי במרכז כל עיגול וקפלו לצורת משולש, צבטו את הקצוות לאטימה.",
      "סדרו את אוזני המן על תבנית האפייה ואפו במשך 12-15 דקות עד להזהבה קלה.",
      "תנו להתקרר לפני ההגשה.",
    ],
    preparationMethodAr: [
      "في وعاء كبير، اخلط الدقيق، البيكنج باودر، الملح، والسكر.",
      "أضف البيض، الزيت النباتي (أو الزبدة المذابة)، وخلاصة الفانيليا. اخلط حتى تتكون عجينة ناعمة.",
      "غلف العجينة بالبلاستيك وضعها في الثلاجة لمدة ساعة.",
      "سخن الفرن إلى 350°F (175°C) وغطِ صينية الخبز بورق الخبز.",
      "افرد العجينة على سطح مرشوش بالدقيق بسمك حوالي 1/4 بوصة وقطع دوائر.",
      "ضع ملعقة صغيرة من الحشوة في وسط كل دائرة واطوِها على شكل مثلث، مع قرص الحواف لإغلاقها.",
      "رتب حبات أذني هامان على صينية الخبز واخبز لمدة 12-15 دقيقة حتى تصبح ذهبية قليلاً.",
      "اتركها لتبرد قبل التقديم.",
    ],
  },
];
